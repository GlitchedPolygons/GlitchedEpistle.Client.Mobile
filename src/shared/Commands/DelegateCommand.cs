...
namespace GlitchedPolygons.GlitchedEpistle.Client.Mobile.Commands
{
    /// <summary>
    ...
    public class DelegateCommand : ICommand
    {
        ...
        /// <param name="executionCheck">The <see cref="ICommand.CanExecute"/> check delegate (can be <c>null</c>; in that case <see cref="ICommand.CanExecute"/> is always <c>true</c>).</param>
        ...
        /// </summary>
        /// <param name="parameter">Data used by the command. If the command does not require data to be passed, this object can be set to <c>null</c>.</param>
        /// <returns><see langword="true" /> if this command can be executed; otherwise, <c>false</c>.</returns>
